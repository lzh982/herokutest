...
from seller_api import walmart_query
...
def index():
    ...
    #walmart API
    if q:
        #walmart_result  = walmart_query(q)
        #games_list.append(walmart_result)
        #print(walmart_result)
        #print(walmart_result)

        walmart_query = "query=" + q
        ...
        for i in walmart_response["organic_results"]:
            ...
            game_data = {
                'title': i['title'],
                'price': i['primary_offer']['offer_price'],
                'initialprice': i['primary_offer']['offer_price'],
                # 'discount' : discount,
                'store': 'Walmart',
